      ...
      <div class="mb-4 border border-blue-200 rounded-lg overflow-hidden">
        ...
        <div v-show="showApiHelp" class="p-4 bg-blue-50 border-t border-blue-200">
          <div class="text-sm text-blue-700 space-y-2">
            <div><strong>OpenAI Chat Completions：</strong>API URL填写完整路径，如 <code class="bg-blue-100 px-1 rounded break-all text-xs">https://api.openai.com/v1/chat/completions</code></div>
            <div><strong>OpenAI Responses：</strong>API URL填写完整路径，如 <code class="bg-blue-100 px-1 rounded break-all text-xs">https://api.openai.com/v1/responses</code></div>
